		...
		<div class="panel-body">
			...
			foreach ($cats as $cat) {
				...
				if ($cat['allow_comment']==1) {
					echo"<span class='comments'>Commenting Disable</span>";
				}
				if ($cat['allow_ads']==1) {
		...
		<div class="container">
			<form class="form-horizontal" action="?do=Insert" method="POST">
				...
				<div class="form-group form-group-lg">
					...
					<div class="col-sm-10 col-md-6">
						<input type="text" name="ordering" class="form-control" placeholder="Enter Number To Arrange The Categories" />
					</div>
				</div>
				<!--End Ordering Field -->
				...
				<div class="form-group form-group-lg">
					...
					<div class="col-sm-10 col-md-6">
					     <div>
						<input id="vis-yes" type="radio" name="vis"
						 value="0" checked />
						 <label for="vis-yes">Yes</label>
						 </div>
						 <div>
						<input id="vis-no" type="radio" name="vis"
						 value="1" checked />
				...
				<!--Start Allow Comentaire Field --> 
				<div class="form-group form-group-lg">
					<label class="col-sm-2 control-label">Allow Commenting</label>
					<div class="col-sm-10">
					     <div>
						<input id="comment-yes" type="radio" name="comments"
						 value="0" checked />
						 <label for="comment-yes">Yes</label>
						 </div>
						 <div>
						<input id="comment-no" type="radio" name="comments"
						 value="1" checked />
...
<?php  
	...
	//Check If User Is Exist in Databasse
		...
		if ($check==1) {
		$existuser= '<div class="alert alert-danger">Sorry This Name Is Exist</div>';
	...
	redirectHome($existuser,6);
		...
		// Insert In DataBase
			$stmt = $con->prepare("INSERT INTO 
					...
					VALUES(:zname, :zdesc, :zorder, :zvis, :zcomment, :zads)");
					$stmt->execute(array(
						'zname' 	=> $name,
						'zdesc' 	=> $desc,
						'zorder' 	=> $order,
